...
public class Tran2Demo {
    //不同函数串一起，跨多个数据库（分布式）
    public static void tast_tran() throws SQLException{
    ...
    private static void tast_db1_tran(DbTranQueue queue) throws SQLException {
    ...
    private static void tast_db2_tran(DbTranQueue queue) throws SQLException {
        //使用了 .await(true) 将不提交事务（交由上一层控制）
        //
    ...
    private static void tast_db3_tran(DbTranQueue queue) throws SQLException {
        //使用了 .await(true) 将不提交事务（交由上一层控制）
        //
